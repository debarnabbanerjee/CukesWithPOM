...
#    And In the Home Page I click on "Woman" section
    ...
    Then I want to see the items with name "<itemName>"
    ...
    Examples:
      ...
      | debarnab.banerjee@gmail.com | California0! | chrome  | Deb Bane    | Printed Dress | You have chosen to pay by bank wire. Here is a short summary of your order: | Your order on My Store is complete.Please send us a bank wire with  - Amount $(\\d+)\\.(\\d+)  - Name of account owner Pradeep Macharla  - Include these details xyz  - Bank name RTP  - Do not forget to insert your order reference TOCYTIOTT in the subject of your bank wire.  An email has been sent with this information. Your order will be sent as soon as we receive payment. If you have questions, comments or concerns, please contact our expert customer support team. |
